...
const Instructor = () => {
  return (
    ...
    <div className=' w-full  border-2 rounded-lg container  border-gray-200 p-2'>
    
   
     <div className=' flex flex-col md:flex-row md:gap-5'>
         <img className='   ' src={TabsInstroctor} alt="instructor" />
         <div className=' w-full mx-auto  flex flex-col gap-3 items-start justify-center'>
          <div>
          <h1 className=' font-heading text-[#171717] text-[20px] md:text-[31px] font-semibold '>Lily Alcelus</h1>
         
         <p className=' font-sans text-[#09B850] md:text-[20px]'>Software Engineer</p> 
          </div>
         <div className=' flex  gap-3'>
          ...
          <div className=' flex gap-3'>
             <div className=' flex items-center gap-1'><GraduationCap color='#FD7E14' /><p className='text-md md:text-lg'>1200 students</p></div>
             <div className=' flex items-center gap-1'>
                <div className=' p-1 flex  bg-[#CCE3FF] rounded-full'><Play size={15}   color="#0074FF" />
                </div><p className='text-md md:text-lg'>12 courses</p></div>
             <div className=' flex items-center gap-1'><p className='text-md md:text-lg'>4.3</p><Star color='#FD7E14' fill='#FD7E14'/></div>
          </div>
         </div>
     </div>
 </div>
